            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="addclassact.php" method="post">
                    Add Class
                    <input type="text" class="form-control" name="stream" required autocomplete="off" /><br /><br />
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <table border="1" class="table table-bordered">
                    ...
                    $db = new DatabaseCon;
                    $s = "select * from tbl_stream where status='true'";
                    $rs = $db->selectData($s);
                    while ($row = mysqli_fetch_array($rs)) {
                    ?>
                      <tr>
                        <td><?php echo $row['stream_name']; ?></td>
                        <td><a href="classdlt.php?id=<?php echo $row['stream_id']; ?>"> <i class="mdi mdi-delete"></i></a></td>
                      </tr>
                    <?php } ?>
                  </table>
