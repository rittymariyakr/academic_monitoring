                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="admno" required class="form-control" value="<?php echo $row['admno']; ?>" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="fn" pattern="[a-z A-Z]+" required class="form-control" value="<?php echo $row['First_name']; ?>" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="mn" pattern="[a-z A-Z]+" required class="form-control" value="<?php echo $row['Middle_nam']; ?>" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="ln" pattern="[a-z A-Z]+" required class="form-control" value="<?php echo $row['Last_name']; ?>" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="fat_name" required class="form-control" value="<?php echo $row['fathername']; ?>" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="mom_name" required class="form-control" value="<?php echo $row['mothername']; ?>" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="fath_occu" required class="form-control" value="<?php echo $row['fatherocc']; ?>" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="mom_occu" required class="form-control" value="<?php echo $row['motherocc']; ?>" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="dob" value="<?php echo $row['dob']; ?>" required class="form-control" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="gender" value="<?php echo $row['gender']; ?>" required class="form-control" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="adr" required class="form-control" value="<?php echo $row['Address']; ?>" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="dist" pattern="[a-z A-Z]+" required class="form-control" value="<?php echo $row['district']; ?>" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="st" pattern="[a-z A-Z]+" required class="form-control" value="<?php echo $row['state']; ?>" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="bg" required class="form-control" value="<?php echo $row['bloodgroup']; ?>" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="rl" pattern="[a-z A-Z]+" required class="form-control" value="<?php echo $row['religion']; ?>" />
                                        </div>
                                    </div>
                                    <center>
                                ...
                                <?php
                                    if(isset($_POST['sub'])){
                                        ...
                                        $fath_occu=$_POST['fath_occu'];
                                        $mom_occu=$_POST['mom_occu'];
                                        $dob=$_POST['dob'];
                                        $gender=$_POST['gender'];
                                        $adr=$_POST['adr'];
                                        $dist=$_POST['dist'];
                                        ...
                                        $sql="UPDATE `tbl_studreg` SET `admno`='$admno',`First_name`='$fn',`Middle_nam`='$mn',`Last_name`='$ln',`dob`='$dob',
                                        `gender`='$gender',`Address`='$adr',`district`='$dist',`state`='$st',`religion`='[value-13]',`gphone`='[value-14]',`bloodgroup`='[value-15]',`fathername`='[value-16]',`mothername`='[value-17]',`fatherocc`='[value-18]',`motherocc`='[value-19]',`image`='[value-20]' WHERE 1"
                                    }
                                ?>
                            </div>
                        </div>
