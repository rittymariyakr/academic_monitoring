            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="utaction.php" method="post">
                    UserType
                    <input type="text" class="form-control" name="ut" required /><br /><br />
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <table border="1" class="table table-bordered">
                    ...
                    $db = new DatabaseCon;
                    $s = "select * from tbl_usertype";
                    $rs = $db->selectData($s);
                    while ($row = mysqli_fetch_array($rs)) {
                    ?>
                      <tr>
                        <td><?php echo $row['usertype_name']; ?></td>
                        <td><a href="delut.php"> <i class="mdi mdi-delete"></i></a></td>
                      </tr>
                    <?php } ?>
                  </table>
