      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="page-header">
            <h4 class="card-title">Assign Teachers</h4>
          </div>
          <div class="row">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="#" method="POST">
                    ...
                    Select Subject : <select class="form-control" name="subject" class="form-control">

                      <?php

                      $qr = "SELECT * FROM tbl_subject";
                    ...
                    Select Teacher : <select class="form-control" name="tr" class="form-control">
                    ...
                    <input type="submit" value="ADD" name="subs" class="btn btn-gradient-primary me-2" />
                  ...
                  if (isset($_POST['subs'])) {
                    ...
                    $tr = $_POST['tr'];
                    $sql = "INSERT INTO `tbl_teacher_subject` (`teacher_id`, `subject_id`) VALUES ('$tr','$subject')";
                    if (mysqli_query($con, $sql)) {
                      echo "<script>alert('Subject assigned ');location.href='assign.php';</script>";
                    } else {
              ...
              <div class="card">
                <div class="card-body">
                  <table border="1" class="table table-bordered">
                    ...
                    $db = new DatabaseCon;
                    $s = "select * from tbl_teacher_subject";
                    $rs = $db->selectData($s);
                    while ($row = mysqli_fetch_array($rs)) {
                      $tea_id = $row['teacher_id'];
                      $sub_id = $row['subject_id'];
                      $sql1 = "SELECT * FROM `tbl_teachreg` where teach_id = '$tea_id'";
                      $sql2 = "SELECT * FROM `tbl_subject` where sub_id = '$sub_id'";
                    ...
                    ?>
                      <tr>
                        ...
                        <td><a href="delete_sub_teacher.php?sub_id=<?= $row['teachsub_id'] ?>"><i class="mdi mdi-delete"></i></a></td>
                      </tr>
                    <?php } ?>
                  </table>
                </div>
