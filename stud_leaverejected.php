                ...
                <div class="card-body">
                  ...
                  <form  action="#" method="post" name=frmtimetable>
                    <table class="table table-striped">
                        ...
                        <?php
                            $sql = "SELECT * FROM `tbl_leave` JOIN `tbl_studreg` ON `tbl_leave`.stud_id=`tbl_studreg`.stud_id WHERE `teach_id` = '$uid' AND status='Rejected'";
                            $counter=0;
                            ...
                            <tr>
                              ...
                              <td><?=$row['reason']?></td>
                              <td><?=$row['session']?></td>
                              <td><font color=red><?=$row['status']?></font></td>
