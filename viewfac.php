...
$s="select * from tbl_teachreg where teach_id='".$_GET['id']."'";
$rs=$db->selectData($s);
...
<label for="exampleInputUsername2" class="col-sm-3 col-form-label">Staf Id</label>
<div class="col-sm-9">
<input type="text" name="stid"  required class="form-control" value="<?php echo $row['staff_id'];?>" readonly />
</div>
  </div>
...
<div class="col-sm-9">
<input type="text" name="fn" pattern="[a-z A-Z]+" required class="form-control" value="<?php echo $row['firstname'];?>" readonly/>
</div>
  </div>
...
<div class="col-sm-9">
<input type="text" name="ln" pattern="[a-z A-Z]+" required class="form-control" value="<?php echo $row['lastname'];?>" readonly/>
</div>
</div>
...
<div class="col-sm-9">
<input type="email" name="fem" required class="form-control" value="<?php echo $row['email'];?>" readonly/>
</div>
</div>

<div class="form-group row">
<label for="exampleInputUsername2" class="col-sm-3 col-form-label">Experience Certificate</label>
<div class="col-sm-9">			  
<a href="<?php echo $row['Experience_certificate'];?>" target="_blank"><img src="<?php echo $row['Experience_certificate'];?>" width="150" height="250"/></a>
</div>
</div>
...
<div class="col-sm-9">
<input type="text" name="exp" required class="form-control" value="<?php echo $row['Experience'];?>" readonly/>
</div>
</div>
...
<div class="col-sm-9">    
<input type="text" name="phn" pattern="[0-9]{10}"required class="form-control" readonly value="<?php echo $row['phno'];?>"/>
</div>
</div>
...
<div class="form-group row">
<label for="exampleInputUsername2" class="col-sm-3 col-form-label">Marital Status</label>
<div class="col-sm-9">
<input type="text" name="ms" pattern="[a-z A-Z]+"required readonly class="form-control" value="<?php echo $row['Maritial_status'];?>"/>
</div>
</div>

<div class="form-group row">
<label for="exampleInputUsername2" class="col-sm-3 col-form-label">Qualification</label>
<div class="col-sm-9">
<input type="text" name="qua" required class="form-control" readonly value="<?php echo $row['qualification'];?>"/>
</div>
</div>
...
<div class="col-sm-9">
<input type="text" name="pos" required class="form-control" readonly value="<?php echo $row['position'];?>"/>
</div>
</div>
...
<div class="col-sm-9">
<input type="text" name="sub" required class="form-control" readonly value="<?php echo $row['Subject'];?>"/>
</div>
</div>
