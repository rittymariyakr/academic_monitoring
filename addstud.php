              ...
              <div class="card">
                <div class="card-body">
                  <form action="studaction.php" method="post">
                    ...
                    Student First Name
                    <input type="text" name="fn" id="fname" required class="form-control" autocomplete="off" onblur="return fnameValidate()"><br />
                  
                    <div id="fnameValidate" style="color:red;"></div>

                    Student Middle Name
                    <input type="text" name="ln" id="lname" required class="form-control" autocomplete="off" onblur="return lnameValidate()"/><br />
