              ...
              <div class="collapse" id="general-pages">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="pages/samples/error-500.html"> 500 </a></li> -->
                   <li class="nav-item"> <a class="nav-link" href="assign.php"> Assign Teacher </a></li>
                  <li class="nav-item"> <a class="nav-link" href="assign_classteacher.php"> Assign Class Teacher </a></li>
                  
				  <li class="nav-item"> <a class="nav-link" href="classtimetable.php"> Add Timetable </a></li>
...
<?php
showcombobox('tbl_stream','stream_id','stream_name');
?>
</select><br/><br/>
