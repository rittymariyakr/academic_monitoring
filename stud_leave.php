                                    ...
                                    <form action="#" method="POST">
                                        <table>
                                            <tr>
                                                ...
                                                <td><input type="text" name="datePick" id="datePick" /></td>
                                            </tr>
                                            <tr>
                                                <td><br></td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td></td>
                                                <td><button type="submit" name="save_date" class="btn btn-primary">Apply
                                                        Leave</button></td>
                                            </tr>
                                        </table>
                                    </form>
...
<?php 
    if(isset($_POST['save_date']))
    {
        ...
        $sql="INSERT INTO `tbl_leave`(`stud_id`, `date`, `reason`) VALUES ('$uid','$date','$reason')";
        $result=mysqli_query($con,$sql);
        if($result){
